...
export default function DoctorSignIn() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post("http://localhost:8080/api/auth/doctor/login", {
                username,
                password,
            });
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100 flex items-center justify-center p-6">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                ...
                <div className="absolute top-1/2 right-1/3 w-64 h-64 bg-blue-100/30 rounded-full blur-3xl animate-pulse-subtle delay-500"></div>
            </div>
            ...
            <div className="relative w-full max-w-md">
                ...
                <div className="bg-white border border-slate-200 rounded-2xl shadow-xl shadow-slate-200/50 overflow-hidden">
                    ...
                    <div className="relative px-8 pt-10 pb-8 text-center">
                        <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-br from-[#0f2744] to-[#1e3a5f] shadow-lg shadow-slate-400/30 mb-6">
                    ...
                    <form onSubmit={handleSubmit} className="px-8 pb-10">
                        ...
                        <button
                            ...
                            className={`w-full mt-8 py-4 rounded-xl font-semibold text-lg tracking-wide transition-all duration-300 transform ${loading
                                ...
                                : "bg-gradient-to-r from-[#0f2744] to-[#1e3a5f] text-white hover:from-[#1a3754] hover:to-[#2d4a6f] shadow-lg shadow-slate-400/30 hover:shadow-xl hover:shadow-slate-400/40 hover:scale-[1.02] active:scale-[0.98]"
                                }`}
                        >
                            {loading ? (
                ...
                <div className="absolute -top-4 -right-4 w-24 h-24 bg-gradient-to-br from-[#0f2744]/10 to-[#1e3a5f]/10 rounded-full blur-xl"></div>
